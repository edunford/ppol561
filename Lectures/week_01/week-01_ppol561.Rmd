...
- **_![:text_color darkred](Being called on)_** 
  ...
  + I will call on you. Read, follow along with the lecture, and you'll be fine
...
> Multicollinearity of variable $X_1$ and $X_2$ could increase the variance of the $\beta_1$ and could explain its statistical insignificance
...
- It's okay to piggy-back on some of the critiques addressed in subsequent publications; but you need think critically here. 

- Be clear and explicit about why you think your proposed adjustment might change the outcome of the analysis. 
...
- Hunt for an **_interesting paper_** (makes the exercise far more enjoyable)
  ...
  + Check out Media publications of academic work, such as the [Monkey Cage](https://www.washingtonpost.com/news/monkey-cage/). These will point to published political science/public policy related work. 
...
- (2) a **cause** (independent variable)
  ...
  - If $X$, then what? 
  - What happens if $X$ goes up or down?
...
- Avoid **_Observational Equivalence_**
  ...
  - Get around this by establishing clear scope conditions; reformulating question/theory/concept
